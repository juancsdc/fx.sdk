...
-- ==
--    table.merge( src [ , dst ]) - Copies single-level without replacing existing values tables; handles non-integer indexes; does not copy metatable
-- ==
...
-- ==
--    table.copy( src [ , dst ]) - Copies single-level without replacing existing values tables; handles non-integer indexes; does not copy metatable
-- ==
function table.copy(src)
	return table.merge(src)
end
